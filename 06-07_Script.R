############################################################################
# Analysis of EU documents & public consultations
############################################################################
# Note: For the results of this study, only the lines 1-680 are relevant.
...
packages <- c("quanteda", "readtext", "qdap", "stringr", "tm", "ggplot2", "ggthemes", "RColorBrewer", "dendextend",
...
### VISUALISATION: ranking of most frequent word stems
...
# install and load packages for dendrogram
...
# retrieve the document names from 'files_all' for the NPM dictionary (by merging data sets) first 
...
# create a dictionary based on the words of the clusters to retrieve relevant key words/phrases (here: word stems)
...
# and only keep these tokens including their context of ±10 tokens
